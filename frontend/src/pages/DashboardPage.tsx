    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Welcome to the Meeting Room Booking System. View today's schedule and quick stats.
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{stats.bookedToday}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{stats.activeNow}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <h3 className="font-medium text-gray-900">View All Rooms</h3>
            <p className="mt-1 text-sm text-gray-600">See room capacities and facilities</p>
          </Link>
          <Link
            to="/calendar"
            className="bg-gray-50 hover:bg-gray-100 rounded-lg p-4 border border-gray-200 transition-colors"
          >
            ...
            <p className="mt-1 text-sm text-gray-600">View bookings in calendar format</p>
          </Link>
          {isAdmin && (
            <Link
              to="/admin"
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-600">Approve pending bookings</p>
            </Link>
          )}
        </div>
      </div>
